...
*/
        ...
        List<HashMap<String, String>> l = getJsonData(System.getProperty("user.dir") + "//src//test//java//org//martinstest//Dataloads//reservationDetails.json");
        return new Object[][]
                {
                        {l.get(0)}, {l.get(1)}
                };
